...
import { AuthCard, InputField, PasswordField, PrimaryButton, RoleSelector, GoogleAuthButton, AuthDivider } from "../components/AuthComponents";
            ...
            <div className="flex w-full lg:w-[45%] items-center justify-center p-6 lg:p-12 relative z-10 py-12 lg:py-6">
                ...
                <div className="w-full max-w-[420px] animate-fade-in-up delay-100">
                    <AuthCard 
                        ...
                        subtitle="Join us for free. No credit card required."
                    >
                        ...
                        <p className="text-center text-slate-400 mt-6 text-[14px]">
                            ...
                            <Link to="/login" className="text-cyan-400 hover:text-cyan-300 font-medium transition-colors ml-1.5">
                                Sign in
                            </Link>
                        </p>
                    </AuthCard>
